...
#define _nstates1	16	/* salvaje */
#define minseq1	15
#define maxseq1	29
#define _endstate1	15

#define _nstates0	16	/* cocinero */
#define minseq0	0
#define maxseq0	14
...
#define Psalvaje	((P1 *)_this)
typedef struct P1 { /* salvaje */
...
#define Pcocinero	((P0 *)_this)
typedef struct P0 { /* cocinero */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
